...
public class StateLogAdvice {
    ...
    @Pointcut("execution(* org.project.service.address.StateTempServiceImpl.*(..))")
    public void tempServiceMethods() {
    }

    @Pointcut("execution(* org.project.service.address.StateServiceImpl.*(..))")
    public void serviceMethods() {
    }

    @Pointcut("execution(* org.project.controller.StateMakerController.*(..))")
    public void makerControllerMethods() {
    }

    @Pointcut("execution(* org.project.controller.StateCheckerController.*(..))")
