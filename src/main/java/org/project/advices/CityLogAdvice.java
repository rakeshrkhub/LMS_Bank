...
public class CityLogAdvice {
    ...
    @Pointcut("execution(* org.project.service.address.CityTempServiceImpl.*(..))")
    public void tempServiceMethods(){}
    @Pointcut("execution(* org.project.service.address.CityServiceImpl.*(..))")
    public void serviceMethods(){}

    @Pointcut("execution(* org.project.controller.CityMakerController.*(..))")
    public void makerControllerMethods(){}
    @Pointcut("execution(* org.project.controller.CityCheckerController.*(..))")
