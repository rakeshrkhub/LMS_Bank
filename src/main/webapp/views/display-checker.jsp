...
<body>
 <%@ include file="navbar.jsp"%>
       ...
       <div class="btnClass">
                 ...
                 &nbsp;
                 <button type="button" class="btn btn-primary" >
                   <a href="<c:url value='authorizePolicy?code=${selectedPolicy.policyCode}'/>" style="color: white; text-decoration:none;">Authorize</a><br>
                 </button>
                 &nbsp;
                 <button type="button" class="btn btn-primary" style="color: white;>
                   <a href=href="<c:url value='rejectPolicy?code=${selectedPolicy.policyCode}'/>" style="color: white; text-decoration:none;">Reject</a>
                 </button>
       </div>
