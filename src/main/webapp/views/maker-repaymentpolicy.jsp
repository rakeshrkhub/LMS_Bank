...
<%@ include file="navbar.jsp"%>
    ...
    <form:form modelAttribute="repaymentPolicy" method="post" action="${pageContext.request.contextPath}/maker/repaymentpolicyinsertion">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2><spring:message code="form.repaymentPolicy.create"/></h2>
                </div>
                <div class="col text-right">
                    <div class="button-bar">
                        <button type="submit" name="submit" value="Save" class="btn btn-primary mr-2"><spring:message code="button.save"/></button>
                        <button type="submit" name="submit" value="Save & Request Approval" class="btn btn-primary mr-2"><spring:message code="button.saveRequestApproval"/></button>
                        <button type="button" name="submit" class="btn btn-secondary"  onclick="window.history.back();"><spring:message code="button.cancel"/></button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <form:input path="repaymentPolicyCode" class="form-control" id="repaymentPolicyCode"  required="true"/>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <form:input path="repaymentPolicyName" class="form-control" id="repaymentPolicyName" />
