...
<%@ include file="navbar.jsp"%>
    <div class="container my-4 card shadow">
        <form:form action="save-and-approve-loan-product" method="post" modelAttribute="loanProductTemp" id="loanProductForm">
            <div class="row justify-content-between align-items-center mb-3 my-4">
                ...
                <div class="col-auto">
                    ...
                    <input type="submit" name="action" value="Save And Request Approval" class="btn btn-primary"/>
            ...
            <div class="form-container">
                <div class="row mb-3">
                    <div class="form-left col-md-6 mb-3">
                        <div class="mb-3">
                           <label for="productCode">Enter Loan Product Code:<span class="rStar">*</span></label>
                           <form:input path="productCode" id="productCode" class="form-control" placeholder="Enter Loan Product Code" required="true" autofocus="autofocus"/>
                        ...
                        <div class="mb-3">
                         ...
                         <div class="mb-3">
                               <label for="productDescription">Enter Product Description:<span class="rStar">*</span> </label>
                    ...
                    <div class="form-right col-md-6 mb-3">
                        <div class="mb-3">
                               <label for="productName">Enter Product Name:<span class="rStar">*</span> </label>
                        ...
                        <div class="mb-3">
                            <label for="rateOfInterest">Enter Rate of Interest:<span class="rStar">*</span> </label>
                        ...
                        <div>
                            <label for="securityType">Select Security Type:<span class="rStar">*</span> </label>
                                 <form:select path="securityType" id="securityType" class="form-control" required= "true">
