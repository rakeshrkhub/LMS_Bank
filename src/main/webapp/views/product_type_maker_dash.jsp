...
<div class="container mt-5" style="display:flex; justify-content:space-between;align-items: baseline;flex-wrap: wrap;margin-top: 20px;">
    <h2>List of Product Type</h2>
    <button class="btn btn-primary fixbutton"><a href="${pageContext.request.contextPath}/maker/product-type-form" style="color:white; text-decoration:none;">Create new Product Type</a></button>
</div>
<hr>
<div class="container">
                ...
                <td>
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-primary">
                            <a href="show-update-product-type?id=${parameter.productTypeId}&status=${parameter.metaData.recordStatus}" style="color: white;">Edit</a>
                        </button>
                        <button type="button" class="btn btn-danger">
                            <a href="delete-product-type?id=${parameter.productTypeId}&status=${parameter.metaData.recordStatus}" style="color: white;">Delete</a>
                        </button>
                    </div>
                </td>
            </tr>
